 ...
 */
@WebServlet("/admin/pageForm/delete/*")
public class PageDeleteServlet extends EkologiaServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		Matcher m = Pattern.compile("\\w*\\/pageForm\\/delete\\/(\\S*)").matcher(
