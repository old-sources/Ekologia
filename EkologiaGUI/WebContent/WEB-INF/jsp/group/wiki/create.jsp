        ...
        <div class="row panel">
            <div class="row">
                <div class="small-2 columns">
                    <label for="form-wiki-create-title" class="right inline"><fmt:message key="title.label"/></label>
                </div>
            ...
            <div class="row">
                <div class="small-2 columns">
                    <label for="form-wiki-create-image" class="right inline"><fmt:message key="image.label"/></label>
                </div>
            ...
            <div class="row ">
                <div class="small-2 columns">
                    <label for="form-wiki-create-content" class="right inline"><fmt:message key="content.label" /></label>
                </div>
